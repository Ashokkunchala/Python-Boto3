# Day 48 — Multi-Account Design

## Goal
Understand profiles and role assumption patterns for controlled account inventory.

## Example
```python
sts.assume_role(RoleArn=role_arn, RoleSessionName="inventory")
```
